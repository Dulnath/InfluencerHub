 ...
 if(url!=null){
  ...
  return (
    ...
    {inputs!=null?(<>
      ...
      <div >
        <input type="submit" label="Upload" style={{marginTop:"50px",backgroundColor:"yellow",padding:"10px",width:"100px",height:"50px",borderRadius:"5px",justifyContent:"center"}}/></div>
      </div>
