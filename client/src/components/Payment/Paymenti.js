...
//console.log(dollers);
  ...
  console.log(sum);
   console.log(notificationsdisplayed);
      ...
      <div style={{height:"50px",width:"170px",color:"red",marginTop:"100px",marginLeft:"100px",backgroundColor:"green",padding:"10px",borderRadius:"20px"}}>Your balance {sum}</div>
  {notificationsdisplayed.map((p)=>(
    <>
    <Container>
    <div style={{backgroundColor:"grey",color:"white",width:"500px",height:"80px",padding:"30px",margin:"5px",borderRadius:"20px"}}>{p.paidby} has made a payment of {p.amount}$  for completing   {p.project}
</div>
